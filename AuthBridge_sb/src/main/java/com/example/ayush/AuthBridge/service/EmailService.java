...
//    public void sendResetOtpEmail(String toMail, String otp) {
//        SimpleMailMessage message = new SimpleMailMessage();
//        message.setFrom(fromEmail);
//        message.setTo(toMail);
//        message.setSubject("Reset Password OTP");
//        message.setText("Your OTP for resetting the password is " + otp + ". Use this OTP to proceed with resetting your password");
//        mailSender.send(message);
//    }
//
