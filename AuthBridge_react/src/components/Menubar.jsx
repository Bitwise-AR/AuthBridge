...
const Menubar = () => {
    ...
    return (
        <nav className="navbar bg-white px-5 px-4 d-flex justify-content-between align-items-center">
            ...
            <img src={assets.logo_home} alt="logo" width={32} height={32} style={{position: "relative"}}/>
                <span className="fw-bold fs-4 text-dark">AuthBridge</span>
            </div>
                    ...
                    {dropdownOpen && (
                        ...
                        >
                            {!userData.isAccountVerified && (
                                <div className="dropdown-item py-1 px-2" style={{cursor: "pointer"}} onClick={sendVerificationEmail}>
                                    Verify Email
                                </div>
                            )}
